<script lang="ts">
	...
	import TableRow from './index.svelte';
...
<Story
	...
	component={TableRow}
	category="Atoms"
	description="A row component for tables."
	{controls}
>
		...
		<section class="grid w-full gap-8 lg:grid-cols-[1fr_1fr]">
			...
			>
				<p class="text-sm font-semibold tracking-wide text-[--color-text-secondary] uppercase">
					Primary Table Row Example
				</p>
				<p class="mt-1 text-[--color-text-primary]">A row component for tables.</p>
			...
			>
				<h3 class="text-base font-semibold text-[--color-text-primary]">Row Variations</h3>
				<p class="text-sm text-[--color-text-secondary]">Different row configurations.</p>

				<div class="mt-5 space-y-4">
					<article
						class="rounded-2xl border border-dashed border-[--color-border-primary] bg-[--color-background-primary] p-4"
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">Striped Row</p>
						<table class="min-w-full divide-y divide-[--color-border-primary]">
							<tbody>
					...
					<article
						class="rounded-2xl border border-dashed border-[--color-border-primary] bg-[--color-background-primary] p-4"
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">Active Row</p>
						<table class="min-w-full divide-y divide-[--color-border-primary]">
							<tbody>
