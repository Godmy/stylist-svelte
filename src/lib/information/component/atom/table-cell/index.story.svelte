...
<Story
	...
	component={TableCell}
	category="Atoms"
	description="A cell component for tables."
	{controls}
>
		...
		<section class="grid w-full gap-8 lg:grid-cols-[1fr_1fr]">
			...
			>
				<p class="text-sm font-semibold tracking-wide text-[--color-text-secondary] uppercase">
					Primary Table Cell Example
				</p>
				<p class="mt-1 text-[--color-text-primary]">A cell component for tables.</p>
			...
			>
				<h3 class="text-base font-semibold text-[--color-text-primary]">Cell Variations</h3>
				<p class="text-sm text-[--color-text-secondary]">Different cell configurations.</p>

				<div class="mt-5 space-y-4">
					<article
						class="rounded-2xl border border-dashed border-[--color-border-primary] bg-[--color-background-primary] p-4"
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">Header Cell</p>
						<table class="min-w-full divide-y divide-[--color-border-primary]">
							<thead>
								<tr>
					...
					<article
						class="rounded-2xl border border-dashed border-[--color-border-primary] bg-[--color-background-primary] p-4"
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">Data Cell</p>
						<table class="min-w-full divide-y divide-[--color-border-primary]">
							<tbody>
								<tr>
									<TableCell variant="data">Data Cell</TableCell>
									<TableCell variant="data">Data Cell</TableCell>
								</tr>
							</tbody>
						</table>
