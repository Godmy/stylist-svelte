<script lang="ts">
	...
	import type { NodeTitleProps } from '$stylist';
	import { createNodeTitleState } from '$stylist/architecture/state/node-title';
	import { NodeTitleStyleManager } from '$stylist';
