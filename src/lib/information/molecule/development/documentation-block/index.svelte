<script lang="ts">
  ...
  import { DocumentationBlockStyleManager } from '$stylist/information/class/style-manager/documentation-block';
  import CodeSection from '$stylist/information/molecule/development/code-section/index.svelte';
