<script lang="ts">
  ...
  import { CodeSectionStyleManager } from '$stylist/information/class/style-manager/code-section';
  import CodeEditor from '$stylist/information/molecule/development/code-editor-legacy/index.svelte';
