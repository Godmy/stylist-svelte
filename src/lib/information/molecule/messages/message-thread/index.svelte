<script lang="ts">
	...
	import type { Message, MessageThreadMessage, MessageThreadProps, User } from '$stylist/information/interface/chat';
	import { createMessageThreadState } from '$stylist/information/state/message-thread';
