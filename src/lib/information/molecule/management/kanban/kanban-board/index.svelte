<script lang="ts">
  ...
  import { KanbanBoardStyleManager } from '$stylist/information/class/style-manager/kanban-board';
  import KanbanColumn, { type KanbanColumnType } from '$stylist/information/molecule/management/kanban/kanban-column/index.svelte';
  import type { KanbanCardType } from '$stylist/information/organism/card/kanban-card/index.svelte';
