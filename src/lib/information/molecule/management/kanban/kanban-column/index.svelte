<script lang="ts">
  ...
  import { KanbanColumnStyleManager } from '$stylist/information/class/style-manager/kanban-column';
  import KanbanCard, { type KanbanCardType } from '$stylist/information/organism/card/kanban-card/index.svelte';
