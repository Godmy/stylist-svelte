<script lang="ts">
  ...
  import { CategoryCardStyleManager } from '$stylist/information/class/style-manager/category-card';
  import Icon from '$stylist/information/atom/media/icon/index.svelte';
