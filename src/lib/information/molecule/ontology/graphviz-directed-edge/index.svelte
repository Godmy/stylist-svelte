<script lang="ts">
  import type { GraphvizDirectedEdgeProps } from '$stylist/information/interface/molecules-migration';
  import { GraphvizDirectedEdgeStyleManager } from '$stylist/information/class/style-manager/molecules-migration';
