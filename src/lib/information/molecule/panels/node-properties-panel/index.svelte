<script lang="ts">
	...
	import type { LiteGraphNodeProperty, NodePropertiesPanelProps } from '$stylist';
	import { createNodePropertiesPanelState } from '$stylist/information/state/node-properties-panel';
