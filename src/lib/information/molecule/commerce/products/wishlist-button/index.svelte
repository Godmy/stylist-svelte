...
const CheckCircle = 'check-circle';
  ...
  import type { WishlistButtonProps } from '$stylist/information/interface/molecules-migration';
  import { WishlistButtonStyleManager } from '$stylist/information/class/style-manager/molecules-migration';
