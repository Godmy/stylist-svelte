<script lang="ts">
  ...
  import { AnalyticsChartStyleManager } from '$stylist/information/class/style-manager/analytics-chart';
  import BarChart from '$stylist/architecture/molecule/canvas/charts/bar-chart/index.svelte';
  import LineChart from '$stylist/architecture/organism/canvas/charts/line-chart/index.svelte';
  import PieChart from '$stylist/information/atom/data-display/charts/chart-pie/index.svelte';
