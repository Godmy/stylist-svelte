<script lang="ts">
  ...
  import type { GeoJsonLayer, MapView, GeoJsonFeature, GeoJsonFeatureCollection } from '$stylist/information/interface/geo-jsonviewer';
  import { Icon as BaseIcon, Button } from '$stylist';
  import { GeoJSONViewerStyleManager } from '$stylist/information/class/style-manager/geo-jsonviewer';
