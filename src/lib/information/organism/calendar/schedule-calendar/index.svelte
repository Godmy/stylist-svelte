<script lang="ts">
  import type { IScheduleCalendarProps, ScheduleTimeSlot, DaySchedule, ScheduleEvent } from '$stylist/information/interface/schedule-calendar';
  import { Icon as BaseIcon, Button } from '$stylist';
  import { TimeSlot } from '$stylist/interaction/atom/controls/calendar/time-slot';
  import { ScheduleCalendarStyleManager } from '$stylist/information/class/style-manager/schedule-calendar';
