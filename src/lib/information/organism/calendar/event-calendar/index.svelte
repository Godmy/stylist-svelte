<script lang="ts">
import type { CalendarEvent, CalendarDay } from '$stylist/information/interface/event-calendar';
import type { TokenTimeMeasure } from '$stylist/information/type/token/time-measure';
  import { Icon as BaseIcon, Button } from '$stylist';
  import { EventCalendarStyleManager } from '$stylist/information/class/style-manager/event-calendar';
