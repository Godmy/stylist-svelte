...
const UserIcon = 'user';
  ...
  import type { CommentThreadItem } from '$stylist/information/interface/comment-thread';
  import { CommentThreadStyleManager } from '$stylist/information/class/style-manager/comment-thread';
