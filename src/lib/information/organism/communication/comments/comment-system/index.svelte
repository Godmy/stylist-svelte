...
const UserIcon = 'user';
  ...
  import type { CommentItem } from '$stylist/information/interface/comment-system';
  import { CommentSystemStyleManager } from '$stylist/information/class/style-manager/comment-system';
