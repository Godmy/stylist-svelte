<script lang="ts">
  ...
  import { resolveAuthGuardState } from '$stylist/interaction/function/auth-guard';
  import { AuthGuardStyleManager } from '$stylist/information/class/style-manager/auth-guard';
