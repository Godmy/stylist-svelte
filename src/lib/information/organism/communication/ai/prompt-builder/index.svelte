...
const Trash2 = 'trash-2';
  ...
  import { PromptBuilderStyleManager } from '$stylist/information/class/style-manager/prompt-builder';
  import type { PromptBuilderProps } from '$stylist/information/interface/prompt-builder';
  import type { PromptVariable } from '$stylist/information/interface/prompt-builder';
