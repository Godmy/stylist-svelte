<script lang="ts">
  ...
  import { TeamMemberCardStyleManager } from '$stylist/information/class/style-manager/team-member-card';
  import Avatar from '$stylist/information/atom/media/avatar/index.svelte';
  import Badge from '$stylist/information/atom/typography/elements/badge/index.svelte';
