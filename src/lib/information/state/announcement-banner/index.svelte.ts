import type { AnnouncementBannerProps } from '$stylist/information/interface/image';
import { MediaStyleManager } from '$stylist/information/class/style-manager/media';
