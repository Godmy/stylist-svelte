...
import { CARD_SIZE_CLASSES } from '$stylist/information/const/record/card-size-classes';
import { PROGRESS_VARIANT_CLASSES } from '$stylist/information/const/record/progress-variant-classes';
