import { CountryFlagStyleManager } from '$stylist/information/class/style-manager/countryflag';
import { IconStyleManager } from '$stylist/information/class/style-manager/icons';
import { ImageStyleManager } from '$stylist/information/class/style-manager/image';
...
export class MediaStyleManager {
	...
	static getIconWrapperClasses(options: {
		...
		variant?:
			...
			| 'dark'
			| 'light';
		shape?: 'circle' | 'square' | 'rectangle' | 'rounded' | 'pill';
