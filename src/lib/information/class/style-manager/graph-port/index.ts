import type { GraphPortState } from '$stylist/information/interface/graph-port';
import type { GraphPortDataTypeColor, GraphPortStateColor } from '$stylist/information/type/attribute/theme-colors';
