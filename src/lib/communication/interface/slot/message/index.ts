...
import type { SlotMessageAttachment } from '$stylist/communication/interface/slot/message-attachment';
import type { SlotMessageReaction } from '$stylist/communication/interface/slot/message-reaction';
