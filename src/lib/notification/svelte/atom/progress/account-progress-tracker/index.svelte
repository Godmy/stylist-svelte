<script lang="ts">
  ...
  import type { IAccountProgressTrackerProps } from '$stylist/notification/interface/component/notification/other';
...
<div class={joinClassNames('account-progress-tracker-container', className)} {...restProps}>
