<script lang="ts">
	...
	import type { RecipeLitegraphCanvas } from '$stylist/workspace/interface/recipe/litegraph-canvas';
	import ConnectionLine from '$stylist/workspace/component/molecule/connection-line/index.svelte';
	import GraphCanvas from '$stylist/workspace/component/atom/graph-canvas/index.svelte';
	import GraphToolbar from '$stylist/workspace/component/molecule/graph-toolbar/index.svelte';
	import Minimap from '$stylist/architecture/component/organism/minimap/index.svelte';
	import LitegraphNodeComponent from '$stylist/workspace/component/molecule/litegraph-node/index.svelte';
	import createLitegraphCanvasState from '$stylist/workspace/function/state/litegraph-canvas/index.svelte';
...
<style>
	...
	.litegraph-canvas__container {
		position: relative;
		flex: 1 1 auto;
		display: flex;
		overflow: hidden;
	}
	.litegraph-canvas__canvas { flex: 1 1 auto; }
	.litegraph-canvas__connections {
		position: absolute;
		top: 0;
		left: 0;
		width: 100%;
	...
	.litegraph-canvas__connections > :global(*) {
		pointer-events: stroke;
	}
	.litegraph-canvas__minimap {
		position: absolute;
		bottom: 1rem;
		right: 1rem;
		z-index: 10;
