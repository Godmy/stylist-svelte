<script lang="ts">
	...
	import createNodePropertiesPanelState from '$stylist/workspace/function/state/node-properties-panel/index.svelte';
...
<style>
	...
	.node-properties-panel__header {
		display: flex;
		align-items: center;
		justify-content: space-between;
		gap: 0.75rem;
	}
	.node-properties-panel__title {
		margin: 0;
		font-size: 0.75rem;
		font-weight: 600;
	}
	.node-properties-panel__content {
		display: flex;
		flex-direction: column;
		gap: 0.75rem;
	}
	.node-properties-panel__group {
		display: flex;
		flex-direction: column;
		gap: 0.5rem;
	}
	.node-properties-panel__group-title {
		margin: 0;
		font-size: 0.75rem;
	...
	.node-properties-panel__list {
		display: flex;
		flex-direction: column;
		gap: 0.5rem;
	}
	.node-properties-panel__empty {
		margin: 0;
		opacity: 0.7;
	}
</style>
