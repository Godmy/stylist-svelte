import { ObjectManagerNodePalette } from '$stylist/workspace/class/object-manager/node-palette';
import type { SlotNodePaletteItem as NodePaletteItem } from '$stylist/workspace/interface/slot/node-palette-item';
