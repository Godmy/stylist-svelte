<script lang="ts">
	import type { RecipeGraphNodeCard } from '$stylist/architecture/interface/recipe/graph-node-card';
	import Button from '$stylist/control/component/atom/button/index.svelte';
	import Icon from '$stylist/svg/component/atom/icon/index.svelte';
	import { createGraphNodeCardState } from '$stylist/architecture/function/state/graph-node-card/index.svelte';
