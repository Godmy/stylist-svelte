<script lang="ts">
	...
	import type { SlotLitegraphConnection as LitegraphConnection } from '$stylist/architecture/interface/slot/litegraph-connection';
	import type { ContractLitegraphNode as LitegraphNode } from '$stylist/architecture/interface/contract/litegraph-node';
