<script lang="ts">
	...
	import NodeIcon from '$stylist/architecture/component/atom/node-icon/index.svelte';
	...
	import type { GraphNodeDraft } from '$stylist/architecture/interface/slot/graph-node-draft';
