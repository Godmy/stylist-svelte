<script lang="ts">
	import type { PortGroupProps } from '$stylist/architecture/type/struct/port-group-props';
	import createPortGroupState from '$stylist/architecture/function/state/port-group/index.svelte';
	import GraphPort from '$stylist/architecture/component/atom/graph-port/index.svelte';
