<script lang="ts">
	...
	import NodeHeader from '$stylist/architecture/component/molecule/node-header/index.svelte';
	import NodeProperty from '$stylist/architecture/component/atom/node-property/index.svelte';
	import PortGroup from '$stylist/architecture/component/molecule/port-group/index.svelte';
	import type { LiteGraphPort } from '$stylist/architecture/type/struct/lite-graph-port';
	import createLiteGraphNodeState from '$stylist/architecture/function/state/litegraph-node/index.svelte';
