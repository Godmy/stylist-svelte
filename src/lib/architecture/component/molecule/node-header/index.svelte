<script lang="ts">
	import type { RecipeNodeHeader } from '$stylist/architecture/interface/recipe/node-header';
	import { createNodeHeaderState } from '$stylist/architecture/function/state/node-header/index.svelte';
