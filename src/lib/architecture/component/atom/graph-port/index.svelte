<script lang="ts">
	...
	import type { RecipeGraphPort } from '$stylist/architecture/interface/recipe/graph-port';
	import type { TokenPropertyType } from '$stylist/architecture/type/enum/property-type';
	import createGraphPortState from '$stylist/architecture/function/state/graph-port/index.svelte';
