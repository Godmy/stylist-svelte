<script lang="ts">
	...
	import type { RecipeNodeProperty as NodePropertyProps } from '$stylist/architecture/interface/recipe/node-property';
	import createNodePropertyState from '$stylist/architecture/function/state/node-property/index.svelte';
