<script lang="ts">
	...
	import type { RecipeNodeTitle } from '$stylist/architecture/interface/recipe/node-title';
	import createNodeTitleState from '$stylist/architecture/function/state/node-title/index.svelte';
