...
import { resolvePresenterSceneLinks, projectSceneCoordinate } from '$stylist/architecture/function/script/scene/presenter/index';
...
export function createPresenterSceneState(contract: PresenterSceneContract) {
	...
	const sceneLinks = $derived(resolvePresenterSceneLinks(contract.nodes ?? []));
