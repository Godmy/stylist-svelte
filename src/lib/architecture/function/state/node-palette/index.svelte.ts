import { ObjectManagerNodePalette } from '$stylist/architecture/class/object-manager/node-palette';
import type { SlotNodePaletteItem as NodePaletteItem } from '$stylist/architecture/interface/slot/node-palette-item';
import type { RecipeNodePalette as NodePaletteProps } from '$stylist/architecture/interface/recipe/node-palette';
