...
const GripVertical = 'grip-vertical';
  ...
  import { SortableGridStyleManager } from '$stylist/information/class/style-manager/sortable-grid';
  import type { SortableGridProps, SortableGridItem } from '$stylist/information/interface/sortable-grid';
