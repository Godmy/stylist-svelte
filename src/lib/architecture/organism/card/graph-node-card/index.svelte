<script lang="ts">
  ...
  import { GraphNodeCardStyleManager } from '$stylist/information/class/style-manager/graph-node-card';
  import type { GraphNodeCardProps, GraphNodeData } from '$stylist';
