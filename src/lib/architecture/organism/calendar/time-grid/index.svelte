<script lang="ts">
  import { TimeSlot as TimeSlotComponent } from '$stylist/interaction/atom/controls/calendar/time-slot';
  import { Icon } from '$stylist';
  import { Button } from '$stylist';
  import type { Snippet } from 'svelte';
  import type { ArchitectureHTMLAttributes } from '$stylist/architecture/type/attribute/item';
  import { TimeSlotStyleManager } from '$stylist';
  ...
  import { TimeGridStyleManager } from '$stylist/architecture/class/style-manager/time-grid';
