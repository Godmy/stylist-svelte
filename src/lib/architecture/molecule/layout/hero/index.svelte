...
import type { TokenBackground } from '$stylist/information/type/token/background';
  ...
  import { HeroStyleManager } from '$stylist/architecture/class/style-manager/hero';
  import AnimatedNumber from '$stylist/information/atom/data-display/animated-number/index.svelte';
