<script lang="ts">
  ...
  import { PageHeaderStyleManager } from '$stylist/architecture/class/style-manager/page-header';
  import Link from '$stylist/information/atom/typography/inline/link/index.svelte';
