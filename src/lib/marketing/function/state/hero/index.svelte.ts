...
export function createHeroState(props: IHeroProps) {
	...
	const containerClasses = $derived(
		HeroStyleManager.getContainerClasses(height as TokenSize, hostClass)
	);
	const backgroundClasses = $derived(
		HeroStyleManager.getBackgroundClasses(backgroundVariant as TokenBackground)
	);
	...
	return {
		...
		get statsContainerClasses() {
			return statsContainerClasses;
		},
		get statItemClasses() {
			return statItemClasses;
		},
		get statValueClasses() {
			return statValueClasses;
		},
		get statLabelClasses() {
			return statLabelClasses;
		},
