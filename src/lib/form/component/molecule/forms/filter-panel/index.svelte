<script lang="ts">
  ...
  import SlotCheckbox from '$stylist/control/component/atom/toggles/checkbox/index.svelte';
  import Select from '$stylist/control/component/molecule/selectors/selector/index.svelte';
