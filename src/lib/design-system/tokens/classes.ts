...
export const ACCESSIBILITY_CLASSES = {
  ...
  focusVisible: 'focus:outline-none focus-visible:outline-2 focus-visible:outline-[--color-primary-500] focus-visible:outline-offset-2',
  focusRing: 'focus:ring-2 focus:ring-offset-2 focus:ring-[var(--color-primary-500)]',
  focusWithin: 'focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-[var(--color-primary-500)]'
} as const;
...
export const BASE_CLASSES = {
  ...
  input: 'w-full rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2 text-sm placeholder:text-[var(--color-text-secondary)] focus:outline-none focus:ring-2',
