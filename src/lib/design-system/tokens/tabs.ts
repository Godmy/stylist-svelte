import type { SemanticVariant, AppearanceStyle, CommonSize } from './variants';
import { STATE_CLASSES } from './classes';

export type TabVariant = SemanticVariant | AppearanceStyle;
export type TabSize = CommonSize;

export const DEFAULT_TAB_VARIANT: TabVariant = 'primary';
export const DEFAULT_TAB_SIZE: CommonSize = 'md';
...
export const TAB_VARIANT_CLASSES: Record<TabVariant, string> = {
  ...
  outline: 'border-2 border-[--color-primary-600] text-[--color-primary-600]',
  subtle: 'bg-[--color-primary-100] text-[--color-primary-600]'
};
