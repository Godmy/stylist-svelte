...
export const DEFAULT_ACCORDION_PANEL_BORDER = 'border-t border-[var(--color-border-secondary)]';
export const DEFAULT_ACCORDION_PANEL_BG = 'bg-[var(--color-background-primary)]';
