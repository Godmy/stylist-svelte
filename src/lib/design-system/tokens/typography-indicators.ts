import type { ColorVariant, CommonSize } from './variants';

export type CounterVariant = ColorVariant;
...
export type StatusIndicatorLabelStatus =
	| 'success'
	| 'warning'
	| 'error'
	| 'info'
...
export const DEFAULT_DOT_COLOR: ColorVariant = 'primary';
export const DEFAULT_DOT_SIZE: CommonSize = 'md';
...
export const DEFAULT_COUNTER_SIZE: CommonSize = 'md';
...
export const DEFAULT_MARKER_COLOR: ColorVariant = 'gray';
export const DEFAULT_MARKER_SIZE: CommonSize = 'md';
...
export const STATUS_INDICATOR_WITH_LABEL_COLOR_CLASSES: Record<
	Exclude<StatusIndicatorLabelStatus, 'custom'>,
	string
> = {
