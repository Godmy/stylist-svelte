...
import { COLORS_SCALES_GRAY } from '$stylist/design-system/tokens/theme/colors-scales/gray';
import { COLORS_SCALES_GREEN } from '$stylist/design-system/tokens/theme/colors-scales/green';
