...
export const CARD_ICON_SIZE_CLASSES = { sm: 'w-4 h-4', md: 'w-6 h-6', lg: 'w-8 h-8' } as const;
...
export const CARD_PROGRESS_FILL_CLASSES = 'h-full transition-all duration-[var(--duration-500)] ease-out';
