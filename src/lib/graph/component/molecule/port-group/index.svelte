<script lang="ts">
	import type { PortGroupProps } from '$stylist/graph/type/struct/port-group-props';
	import createPortGroupState from '$stylist/graph/function/state/port-group/index.svelte';
	import GraphPort from '$stylist/graph/component/atom/graph-port/index.svelte';
