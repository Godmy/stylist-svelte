<script lang="ts">
	...
	import NodeHeader from '$stylist/graph/component/molecule/node-header/index.svelte';
	import NodeProperty from '$stylist/graph/component/atom/node-property/index.svelte';
	import PortGroup from '$stylist/graph/component/molecule/port-group/index.svelte';
	import type { LiteGraphPort } from '$stylist/graph/type/struct/lite-graph-port';
	import createLiteGraphNodeState from '$stylist/graph/function/state/litegraph-node/index.svelte';
