<script lang="ts">
	...
	import LitegraphCanvas from '$stylist/graph/component/organism/litegraph-canvas/index.svelte';
	...
	import type { GraphEditorProps } from '$stylist/graph/type/struct/graph-editor-props';
	import createGraphEditorState from '$stylist/graph/function/state/graph-editor/index.svelte';
