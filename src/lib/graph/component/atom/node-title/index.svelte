<script lang="ts">
	...
	import type { RecipeNodeTitle } from '$stylist/graph/interface/recipe/node-title';
	import createNodeTitleState from '$stylist/graph/function/state/node-title/index.svelte';
