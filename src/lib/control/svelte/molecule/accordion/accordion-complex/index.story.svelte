<script lang="ts">
  ...
  import AccordionItem from '$stylist/control/svelte/atom/accordion/accordion-item/index.svelte';
  import AccordionHeader from '$stylist/control/svelte/atom/accordion/accordion-header/index.svelte';
  import AccordionPanel from '$stylist/control/svelte/atom/accordion/accordion-panel/index.svelte';
