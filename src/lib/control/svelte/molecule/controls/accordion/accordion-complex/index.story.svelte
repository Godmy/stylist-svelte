<script lang="ts">
  ...
  import AccordionItem from '$stylist/control/svelte/atom/controls/accordion/accordion-item/index.svelte';
  import AccordionHeader from '$stylist/control/svelte/atom/controls/accordion/accordion-header/index.svelte';
  import AccordionPanel from '$stylist/control/svelte/atom/controls/accordion/accordion-panel/index.svelte';
