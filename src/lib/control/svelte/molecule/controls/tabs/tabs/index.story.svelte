<script lang="ts">
  ...
  import TabList from '$stylist/control/svelte/atom/controls/tabs/tab-list/index.svelte';
  import { Tab } from '$stylist/control/svelte/atom/controls/tabs/tab';
  import TabPanel from '$stylist/control/svelte/atom/controls/tabs/tab-panel/index.svelte';
  import TabPanels from '$stylist/control/svelte/atom/controls/tabs/tab-panels/index.svelte';
