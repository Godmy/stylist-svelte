<script lang="ts">
  import { PaymentSummaryStyleManager } from '$stylist/control/class/style-manager/payment-summary-style-manager';
  import type { PaymentSummaryProps } from '$stylist/control/type/struct/payment-summary-props';
  import type { PaymentSummaryDiscount } from '$stylist/control/type/struct/payment-summary-discount';
  import type { PaymentSummaryItem } from '$stylist/control/type/struct/payment-summary-item';
  import type { PaymentSummaryTax } from '$stylist/control/type/struct/payment-summary-tax';
