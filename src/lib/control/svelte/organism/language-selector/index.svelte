<script lang="ts">
  ...
  import type { ILanguageSelectorProps } from '$stylist/control/interface/component/language-selector/struct/props';
  import { Icon as BaseIcon } from '$stylist';
  import { LanguageSelectorStyleManager } from '$stylist/control/class/style-manager/language-selector';
