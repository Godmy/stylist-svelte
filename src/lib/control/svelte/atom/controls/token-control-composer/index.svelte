<script lang="ts">
import TokenRadioControl from '$stylist/control/svelte/atom/controls/token-radio/index.svelte';
import TokenRangeControl from '$stylist/control/svelte/atom/controls/token-range/index.svelte';
import TokenSelectControl from '$stylist/control/svelte/atom/controls/token-select/index.svelte';
import TokenTextControl from '$stylist/control/svelte/atom/controls/token-text/index.svelte';
	import type { TokenControlDefinition, TokenValue } from '$stylist/control/type/struct/token-control-definition';
