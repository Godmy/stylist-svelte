...
>
	{#snippet children(values: any)}
		<div class="sb-organisms-table-with-stripes p-4">
			<h1 class="mb-4 text-lg font-semibold">TableWithStripes Component</h1>

			<div class="mb-6 rounded border p-4">
				<h2 class="text-md mb-2 font-semibold">Interactive TableWithStripes</h2>
				<div class="max-w-4xl">
					<TableWithStripes {data} {columns} />
				</div>
			</div>
		</div>
	{/snippet}
