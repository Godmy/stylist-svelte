...
>
	{#snippet children(values: any)}
		<div class="sb-organisms-table-with-filters p-4">
			<h1 class="mb-4 text-lg font-semibold">TableWithFilters Component</h1>

			<div class="mb-6 rounded border p-4">
				<h2 class="text-md mb-2 font-semibold">Interactive TableWithFilters</h2>
				<div class="max-w-4xl">
					<TableWithFilters {data} {columns} />
				</div>
			</div>
		</div>
	{/snippet}
