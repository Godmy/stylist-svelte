<script lang="ts">
  ...
  import AccordionItem from '$stylist/control/component/atom/accordion-item/index.svelte';
  import AccordionHeader from '$stylist/control/component/atom/accordion-header/index.svelte';
  import AccordionPanel from '$stylist/control/component/atom/accordion-panel/index.svelte';
