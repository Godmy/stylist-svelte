<script lang="ts">
  ...
  import TabList from '$stylist/control/component/atom/tabs/tab-list/index.svelte';
  import { Tab } from '$stylist/control/component/atom/tabs/tab';
  import TabPanel from '$stylist/control/component/atom/tabs/tab-panel/index.svelte';
  import TabPanels from '$stylist/control/component/atom/tabs/tab-panels/index.svelte';
