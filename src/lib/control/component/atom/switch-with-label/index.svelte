...
<div class={state.containerClasses} role="switch" aria-checked={state.checked} {...restProps}>
	{#if labelPosition === 'left'}
		<label for="switch-input" class={`${state.labelPositionClass} ${state.labelClasses}`}>
			{label}
		</label>
	{/if}
