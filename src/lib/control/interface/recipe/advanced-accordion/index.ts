/**
 * Advanced Accordion вЂ” Р°РєРєРѕСЂРґРµРѕРЅ СЃ РїРѕРґРґРµСЂР¶РєРѕР№ РјРЅРѕР¶РµСЃС‚РІРµРЅРЅРѕРіРѕ СЂР°СЃРєСЂС‹С‚РёСЏ.
 *
 * LEGO-СЃРѕСЃС‚Р°РІ:
...
export interface AdvancedAccordionRecipe
