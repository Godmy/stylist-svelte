import type { SlotRangeInput as Slot } from '$stylist/control/interface/slot/range-input';
import type { SlotRangeInput as SlotRangeInput } from '$stylist/control/interface/slot/range-input';
