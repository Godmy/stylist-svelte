<script lang="ts">
	...
	import createModelSelectorState from '$stylist/ai/function/state/model-selector/index.svelte';
				...
				>
					<div class={state.modelDetailsContainerClass}>
						<div class="model-selector__item-header">
							...
							<p class={state.modelProviderVersionClass}>{model.provider} В· v{model.version}</p>
						</div>
