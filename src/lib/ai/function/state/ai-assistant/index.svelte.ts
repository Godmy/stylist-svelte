...
export function createAiAssistantState(props: RecipeAiAssistant) {
	...
	const headerClass = $derived('ai-assistant__header');
	const messagesContainerClass = $derived('ai-assistant__messages');
	const inputContainerClass = $derived('ai-assistant__input');
	const errorBannerClass = $derived('ai-assistant__error');
