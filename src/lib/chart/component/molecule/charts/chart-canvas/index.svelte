<script lang="ts">
	...
	import ChartAxisX from '$stylist/chart/component/atom/charts/chart-axis-x/index.svelte';
	import ChartAxisY from '$stylist/chart/component/atom/charts/chart-axis-y/index.svelte';
	import ChartAxisZ from '$stylist/chart/component/atom/charts/chart-axis-z/index.svelte';
	import ChartBackground from '$stylist/chart/component/atom/charts/chart-background/index.svelte';
	import ChartName from '$stylist/chart/component/atom/charts/chart-name/index.svelte';
	import ChartPolyline from '$stylist/chart/component/atom/charts/chart-polyline/index.svelte';
