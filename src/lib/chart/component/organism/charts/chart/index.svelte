<script lang="ts">
	...
	import ChartCanvas from '$stylist/chart/component/molecule/charts/chart-canvas/index.svelte';
	import ChartLegend from '$stylist/chart/component/molecule/charts/chart-legend/index.svelte';
