...
import { NOTIFICATION_ITEM_TYPE_CLASSES } from '$stylist/chat/const/map/notification-item-type-classes';
import { NOTIFICATION_BADGE_STATE_CLASSES } from '$stylist/chat/const/map/notification-badge-state-classes';
...
export class NotificationStyleManager {
	...
	static item(
		...
		return mergeClassNames(
			base,
			type ? NOTIFICATION_ITEM_TYPE_CLASSES[type] : RESPONSE_VIEWER_STATUS_CLASSES.info,
			className
		);
	}
