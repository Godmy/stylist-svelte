<script lang="ts">
	...
	const wrapperClasses = $derived(cn(TimeGridStyleManager.getWrapperClasses(), hostClass));
	const headerClasses = $derived(cn(TimeGridStyleManager.getHeaderClasses(), headerClass));
