		...
		<section class="sb-organisms-event-calendar grid w-full gap-8 lg:grid-cols-[1fr_1fr]">
			...
			>
				...
				<p class="mt-1 text-[--color-text-primary]">
					Interactive calendar with event management features.
				</p>
			...
			>
				...
				<div class="mt-5 space-y-4">
					...
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">Week View</p>
						<div class="h-80">
							<EventCalendar
								events={sampleEvents as any}
								initialDate={new Date()}
					...
					<article
						class="rounded-2xl border border-dashed border-[--color-border-primary] bg-[--color-background-primary] p-4"
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">Day View</p>
						<div class="h-80">
							<EventCalendar
								events={sampleEvents as any}
								initialDate={new Date()}
					...
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">
							Month View with Limited Events
						</p>
						<div class="h-80">
							<EventCalendar
