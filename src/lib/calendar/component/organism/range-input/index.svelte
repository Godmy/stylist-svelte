<script lang="ts">
	import type { RecipeRangeInput } from '$stylist/calendar/interface/recipe/range-input';
	import { createRangeInputState } from '$stylist/calendar/function/state/range-input/index.svelte';
