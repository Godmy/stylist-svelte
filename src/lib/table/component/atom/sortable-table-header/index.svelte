<script lang="ts">
	import { PresetSortableTableHeader } from '$stylist/table/const/preset/sortable-table-header';
	import type { RecipeSortableTableHeader } from '$stylist/table/interface/recipe/sortable-table-header';
	import { createSortableTableHeaderState } from '$stylist/table/function/state/sortable-table-header/index.svelte';
