...
export type { GraphPortDataTypeColor } from './graph-port';
...
export type { ViewportContract, ViewportProps } from './viewport';
export type { GraphPortStateColor } from './graph-port';