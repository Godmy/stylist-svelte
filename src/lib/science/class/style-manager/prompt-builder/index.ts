export class PromptBuilderStyleManager {
	...
	static getCopyButtonClass(isCopied: boolean): string {
		const baseClass =
			'inline-flex items-center px-[--spacing-sm] py-[--spacing-xs] border border-[--color-border-primary] text-sm font-medium rounded-md text-[--color-text-primary] bg-[--color-background-primary] hover:bg-[--color-background-secondary] focus:outline-none';
	...
	static getRunButtonClass(isRunning: boolean): string {
		const baseClass =
			'inline-flex items-center px-[--spacing-sm] py-[--spacing-xs] border border-transparent text-sm font-medium rounded-md shadow-sm text-[--color-text-inverse] bg-[--color-primary-600] hover:bg-[--color-primary-700] focus:outline-none';
	...
	static getPromptEditorClass(editorClass = ''): string {
		const baseClass =
			'w-full h-48 p-[--spacing-sm] border border-[--color-border-primary] rounded-md shadow-sm focus:outline-none focus:ring-[--color-primary-500] focus:border-[--color-primary-500] font-mono text-sm';
