	...
	static getNodeStyle(nodeType: string) {
		switch (nodeType) {
			...
			case 'datatype-property':
				return {
					shape: 'rounded-md',
					border: 'border-[--color-secondary-500]',
					bg: 'bg-[--color-secondary-50]',
					text: 'text-[--color-secondary-700]',
					icon: 'database'
				};
			case 'datatype':
				return {
			...
			case 'deprecated':
				return {
					...
					border: 'border-[--color-neutral-400]',
					bg: 'bg-[--color-neutral-100]',
					text: 'text-[--color-neutral-500]',
					icon: 'x'
				};
