		...
		<section class="grid w-full gap-8 lg:grid-cols-[1fr_1fr]">
			...
			>
				<p class="text-sm font-semibold tracking-wide text-[--color-text-secondary] uppercase">
					Primary Promo Banner Example
				</p>
				<p class="mt-1 text-[--color-text-primary]">A promotional banner component.</p>
			...
			>
				...
				<div class="mt-5 space-y-4">
					...
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">Success Banner</p>
						<PromoBanner
							title="Special Offer"
					...
					<article
						class="rounded-2xl border border-dashed border-[--color-border-primary] bg-[--color-background-primary] p-4"
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">Warning Banner</p>
						<PromoBanner
							title="Limited Stock"
