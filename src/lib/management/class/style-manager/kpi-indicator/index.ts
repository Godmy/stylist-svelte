...
export class KPIIndicatorStyleManager {
	...
	static getStatusColorClasses(status: TokenKPI): string {
		const statusColorClasses: Record<TokenKPI, string> = {
			'on-track':
				'bg-[--stylist-kpi-on-track-bg] border-[--stylist-kpi-on-track-border] [--stylist-kpi-progress-color:var(--stylist-kpi-on-track-progress)]',
			'at-risk':
				'bg-[--stylist-kpi-at-risk-bg] border-[--stylist-kpi-at-risk-border] [--stylist-kpi-progress-color:var(--stylist-kpi-at-risk-progress)]',
			'off-track':
				'bg-[--stylist-kpi-off-track-bg] border-[--stylist-kpi-off-track-border] [--stylist-kpi-progress-color:var(--stylist-kpi-off-track-progress)]',
			exceeded:
				'bg-[--stylist-kpi-exceeded-bg] border-[--stylist-kpi-exceeded-border] [--stylist-kpi-progress-color:var(--stylist-kpi-exceeded-progress)]'
		};
