...
import { Icon as BaseIcon } from '$stylist'; const X = 'x'; const CheckCircle = 'check-circle'; const AlertCircle = 'alert-circle'; const Info = 'info'; const XCircle = 'x-circle';
import type { INotificationProps } from '$stylist/interaction/type/attribute/notification';
import type { NotificationType } from '$stylist/interaction/type/attribute/notification';
import type { TokenAppearance } from '$stylist/information/type/token/appearance';
  import { NotificationAtomStyleManager } from '$stylist/interaction/class/style-manager/notification';
