<script lang="ts">
	...
	import { createChatPreviewState } from '$stylist/interaction/state/chat-preview';
	import type { ChatPreviewProps } from '$stylist/interaction/type/attribute/chat-preview';
