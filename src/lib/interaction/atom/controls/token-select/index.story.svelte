<script lang="ts">
	...
	import type { TokenSelectControlDefinition } from '$stylist/interaction/type/token-control-definition';
...
<Story
	...
	description="Select-контрол для выбора значения токена из выпадающего списка"
	tags={['token', 'select', 'dropdown']}
>
