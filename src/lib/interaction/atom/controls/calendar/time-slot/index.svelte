<script lang="ts">
  import type { ITimeSlotProps } from '$stylist/interaction/interface/time-slot';
  import { TimeSlotStyleManager } from '$stylist/interaction/class/style-manager/time-slot';
