<script lang="ts">
import TokenRadioControl from '$stylist/interaction/atom/controls/token-radio/index.svelte';
import TokenRangeControl from '$stylist/interaction/atom/controls/token-range/index.svelte';
import TokenSelectControl from '$stylist/interaction/atom/controls/token-select/index.svelte';
import TokenTextControl from '$stylist/interaction/atom/controls/token-text/index.svelte';
	import type { TokenControlDefinition, TokenValue } from '$stylist/interaction/type/token-control-definition';
