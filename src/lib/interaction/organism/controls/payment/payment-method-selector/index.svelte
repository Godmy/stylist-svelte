<script lang="ts">
  ...
  import type { PaymentMethodSelectorProps } from '$stylist/interaction/type/attribute/payment-controls';
  import type { PaymentMethod } from '$stylist/interaction/type/attribute/payment-controls';
