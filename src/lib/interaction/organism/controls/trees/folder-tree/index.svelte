<script lang="ts">
  import { TreeControlsStyleManager } from '$stylist/interaction/class/style-manager/tree-controls';
  import type { VirtualTreeProps } from '$stylist/interaction/type/attribute/tree-controls';
  import type { TreeNode } from '$stylist/interaction/type/attribute/tree-controls';
