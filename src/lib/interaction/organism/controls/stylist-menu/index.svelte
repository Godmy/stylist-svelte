<script lang="ts">
	...
	import BaseIcon from '$stylist/information/atom/media/icon/index.svelte';
	import StylistTab from '$stylist/interaction/molecule/controls/tabs/stylist-tab/index.svelte';
