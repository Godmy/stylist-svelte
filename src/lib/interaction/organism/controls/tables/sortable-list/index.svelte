...
const MoreHorizontal = 'more-horizontal';
  ...
  import type { SortableListProps } from '$stylist/interaction/interface/table-controls';
  import type { SortableListItem } from '$stylist/interaction/interface/table-controls';
