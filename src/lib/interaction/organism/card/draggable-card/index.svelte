...
const MoreHorizontal = 'more-horizontal';
  ...
  import BaseCard from '$stylist/information/molecule/cards/base-card/index.svelte';
  import { DraggableCardStyleManager } from '$stylist/interaction/class/style-manager/draggable-card';
