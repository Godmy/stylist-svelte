...
const ImageIcon = 'image';
  ...
  import { BulkOrderFormModel } from '$stylist/interaction/state/bulk-order-form';
  import type { BulkOrderFormProps } from '$stylist/interaction/type/attribute/bulk-order-form';
  import { BulkOrderFormStyleManager } from '$stylist/interaction/class/style-manager/bulk-order-form';
