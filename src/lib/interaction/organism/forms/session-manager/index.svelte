<script lang="ts">
  ...
  import type { SessionManagerProps } from '$stylist/interaction/interface/interaction-forms';
  let { activeSessions=1, expiresAt='2026-12-31 23:59', class: className='', ...restProps }: SessionManagerProps = $props();
</script>
