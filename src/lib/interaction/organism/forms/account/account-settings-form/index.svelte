<script lang="ts">
  import type { AccountSettingsFormProps } from '$stylist/interaction/interface/account-forms';
  import { AccountFormsStyleManager } from '$stylist/interaction/class/style-manager/account-forms';
