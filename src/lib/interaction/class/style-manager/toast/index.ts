import type { IToastStyleClasses } from '$stylist/interaction/type/attribute/toast';
import type { ToastNotificationType } from '$stylist/interaction/type/attribute/toast';
