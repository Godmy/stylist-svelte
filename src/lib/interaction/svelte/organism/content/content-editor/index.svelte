<script lang="ts">
	...
	import { createContentEditorState, type ContentType } from '$stylist/interaction/function/state/content-editor';
	import { ContentEditorStyleManager } from '$stylist/interaction/class/style-manager/content-editor';
