<script lang="ts">
  import type { PropsEditorProps } from '$stylist/information/interface/molecules-migration';
  import { PropsEditorStyleManager } from '$stylist/information/class/style-manager/molecules-migration';
