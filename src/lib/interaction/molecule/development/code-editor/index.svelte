...
const RefreshCw = 'refresh-cw';
  ...
  import type { CodeEditorProps } from '$stylist/information/interface/molecules-migration';
  import { CodeEditorStyleManager } from '$stylist/information/class/style-manager/molecules-migration';
