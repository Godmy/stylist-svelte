...
const ChevronDown = 'chevron-down';
  ...
  import { ModelSelectorStyleManager } from '$stylist/interaction/class/style-manager/model-selector';
  import type { Model, ModelSelectorProps } from '$stylist/interaction/type/attribute/model-selector';
