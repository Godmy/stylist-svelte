<script lang="ts">
  ...
  import AccordionItem from '$stylist/interaction/atom/controls/accordion/accordion-item/index.svelte';
  import AccordionHeader from '$stylist/interaction/atom/controls/accordion/accordion-header/index.svelte';
  import AccordionPanel from '$stylist/interaction/atom/controls/accordion/accordion-panel/index.svelte';
