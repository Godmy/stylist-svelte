<script lang="ts">
  import type { IAdvancedAccordionProps, IAdvancedAccordionItem } from '$stylist/interaction/interface/advanced-accordion';
  import { AdvancedAccordionStyleManager } from '$stylist/interaction/class/style-manager/advanced-accordion';
