<script lang="ts">
  ...
  import TabList from '$stylist/interaction/atom/controls/tabs/tab-list/index.svelte';
  import { Tab } from '$stylist/interaction/atom/controls/tabs/tab';
  import TabPanel from '$stylist/interaction/atom/controls/tabs/tab-panel/index.svelte';
  import TabPanels from '$stylist/interaction/atom/controls/tabs/tab-panels/index.svelte';
