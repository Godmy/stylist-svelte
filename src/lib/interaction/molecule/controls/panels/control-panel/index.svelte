<script lang="ts">
  import SearchBar from '$stylist/interaction/molecule/search/search-bar/index.svelte';

  import FilterPanel from '$stylist/interaction/molecule/forms/filter-panel/index.svelte';
  import Toolbar from '$stylist/interaction/molecule/controls/toolbars/toolbar/index.svelte';
