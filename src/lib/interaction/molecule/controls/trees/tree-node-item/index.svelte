<script lang="ts">
  import type { ITreeNodeItemProps, TreeNodeItemNode } from '$stylist/interaction/type/attribute/tree-node-item';
  import { Icon as BaseIcon } from '$stylist';
  import { TreeNodeItemStyleManager } from '$stylist/interaction/class/style-manager/tree-node-item';
