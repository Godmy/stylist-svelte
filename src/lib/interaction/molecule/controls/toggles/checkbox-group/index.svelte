<script lang="ts">
  ...
  import Checkbox from '$stylist/interaction/atom/controls/toggles/checkbox/index.svelte';
  import { CheckboxGroupStyleManager } from '$stylist/interaction/class/style-manager/checkbox-group';
