<script lang="ts">
import type { User, Message } from '$stylist/information/interface/chat';
import MessageList from '$stylist/information/molecule/messages/message-list/index.svelte';
  import MessageInput from '$stylist/interaction/atom/input/message-input/index.svelte';
