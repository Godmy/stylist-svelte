export class CommentSystemStyleManager {
	...
	static getInputClass(inputClass = ''): string {
		const base =
			'block w-full rounded-md border border-[--color-border-primary] bg-[--color-background-primary] px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[--color-primary-500]';
