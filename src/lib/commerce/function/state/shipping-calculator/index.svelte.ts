...
export function createShippingCalculatorState(props: ShippingCalculatorContract) {
	...
	const containerClasses = $derived(
		ShippingCalculatorStyleManager.getContainerClasses(String(props.class ?? ''))
	);
	...
	const resultsContainerClasses = $derived(
		ShippingCalculatorStyleManager.getResultsContainerClasses()
	);
	const optionNameClasses = $derived(ShippingCalculatorStyleManager.getOptionNameClasses());
	const optionDescriptionClasses = $derived(
		ShippingCalculatorStyleManager.getOptionDescriptionClasses()
	);
	...
	const calculateButtonClasses = $derived(
		ShippingCalculatorStyleManager.getCalculateButtonClasses()
	);
