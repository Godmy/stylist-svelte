...
export function createOrderTrackingState(props: OrderTrackingContract) {
	...
	const containerClasses = $derived(
		OrderTrackingStyleManager.getContainerClasses(String(props.class ?? ''))
	);
	...
	const progressContainerClasses = $derived(
		OrderTrackingStyleManager.getProgressContainerClasses()
	);
	...
	const timelineContainerClasses = $derived(
		OrderTrackingStyleManager.getTimelineContainerClasses()
	);
	...
	return {
		...
		get progressContainerClasses() {
			return progressContainerClasses;
		},
		...
		get timelineContainerClasses() {
			return timelineContainerClasses;
		},
		get timelineItemClasses() {
			return timelineItemClasses;
		},
		get timelineContentClasses() {
			return timelineContentClasses;
		},
		get eventTitleClasses() {
			return eventTitleClasses;
		},
		get eventDescriptionClasses() {
			return eventDescriptionClasses;
		},
		get eventDateClasses() {
			return eventDateClasses;
		},
