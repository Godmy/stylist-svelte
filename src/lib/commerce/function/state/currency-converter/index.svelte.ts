...
export function createCurrencyConverterState(props: CurrencyConverterContract) {
	...
	const containerClasses = $derived(
		CurrencyConverterStyleManager.getContainerClasses(String(props.class ?? ''))
	);
	...
	const resultContainerClasses = $derived(
		CurrencyConverterStyleManager.getResultContainerClasses()
	);
	...
	const switchContainerClasses = $derived(
		CurrencyConverterStyleManager.getSwitchContainerClasses()
	);
	...
	return {
		...
		get resultContainerClasses() {
			return resultContainerClasses;
		},
		get resultClasses() {
			return resultClasses;
		},
		get exchangeRateClasses() {
			return exchangeRateClasses;
		},
		get feeClasses() {
			return feeClasses;
		},
		...
		get switchContainerClasses() {
			return switchContainerClasses;
		},
		get switchButtonClasses() {
			return switchButtonClasses;
		},
		getCurrencySymbol,
		handleConvert
	};
