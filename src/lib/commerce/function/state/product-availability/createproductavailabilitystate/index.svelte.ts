...
export function createProductAvailabilityState(props: ProductAvailabilityProps) {
	...
	const notificationFormClass = $derived(
		ProductAvailabilityStyleManager.getNotificationFormClass()
	);
	const notificationTextClass = $derived(
		ProductAvailabilityStyleManager.getNotificationTextClass()
	);
	...
	const notifySubmitButtonClass = $derived(
		ProductAvailabilityStyleManager.getNotifySubmitButtonClass()
	);
	...
	return {
		...
		get notifyButtonClass() {
			return notifyButtonClass;
		},
		get notificationFormClass() {
			return notificationFormClass;
		},
		get notificationTextClass() {
			return notificationTextClass;
		},
		get formContainerClass() {
			return formContainerClass;
		},
		get emailInputClass() {
			return emailInputClass;
		},
		get notifySubmitButtonClass() {
			return notifySubmitButtonClass;
		},
		showForm() {
