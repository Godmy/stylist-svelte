...
export function createShippingInfoState(props: ShippingInfoContract) {
	...
	const containerClasses = $derived(
		ShippingInfoStyleManager.getContainerClasses(String(props.class ?? ''))
	);
	...
	const shippingDetailsContainerClasses = $derived(
		ShippingInfoStyleManager.getShippingDetailsContainerClasses()
	);
	const shippingDetailItemClasses = $derived(
		ShippingInfoStyleManager.getShippingDetailItemClasses()
	);
	const shippingDetailLabelClasses = $derived(
		ShippingInfoStyleManager.getShippingDetailLabelClasses()
	);
	const shippingDetailValueClasses = $derived(
		ShippingInfoStyleManager.getShippingDetailValueClasses()
	);
	...
	const freeShippingProgressClasses = $derived(
		ShippingInfoStyleManager.getFreeShippingProgressClasses()
	);
	const freeShippingProgressFillClasses = $derived(
		ShippingInfoStyleManager.getFreeShippingProgressFillClasses()
	);
	...
	return {
		...
		get optionsContainerClasses() {
			return optionsContainerClasses;
		},
		get optionClasses() {
			return optionClasses;
		},
		get optionNameClasses() {
			return optionNameClasses;
		},
		get optionDescriptionClasses() {
			return optionDescriptionClasses;
		},
		get optionPriceClasses() {
			return optionPriceClasses;
		},
		get deliveryTimeClasses() {
			return deliveryTimeClasses;
		},
		get regionsContainerClasses() {
			return regionsContainerClasses;
		},
		get regionItemClasses() {
			return regionItemClasses;
		},
		get regionNameClasses() {
			return regionNameClasses;
		},
		get countriesListClasses() {
			return countriesListClasses;
		},
		get shippingDetailsContainerClasses() {
			return shippingDetailsContainerClasses;
		},
		get shippingDetailItemClasses() {
			return shippingDetailItemClasses;
		},
		get shippingDetailLabelClasses() {
			return shippingDetailLabelClasses;
		},
		get shippingDetailValueClasses() {
			return shippingDetailValueClasses;
		},
		get freeShippingBadgeClasses() {
			return freeShippingBadgeClasses;
		},
		get iconClasses() {
			return iconClasses;
		},
		get freeShippingProgressClasses() {
			return freeShippingProgressClasses;
		},
		get freeShippingProgressFillClasses() {
			return freeShippingProgressFillClasses;
		},
		formatPrice,
		formatDelivery,
		handleOptionSelect
