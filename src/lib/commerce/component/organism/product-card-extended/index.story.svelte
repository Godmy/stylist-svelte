		...
		<section class="sb-organisms-product-card-extended grid w-full gap-8 lg:grid-cols-[1fr_1fr]">
			...
			>
				...
				<p class="mt-1 text-[--color-text-primary]">
					Interactive product card with detailed information and actions.
				</p>
			...
			>
				...
				<div class="mt-5 space-y-4">
					...
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">Featured Product</p>
						<div>
							<ProductCardExtended
								{...sampleProduct}
								badge="Featured"
					...
					<article
						class="rounded-2xl border border-dashed border-[--color-border-primary] bg-[--color-background-primary] p-4"
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">New Arrival</p>
						<div>
							<ProductCardExtended
								{...sampleProduct}
								badge="New"
