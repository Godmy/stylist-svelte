		...
		<section class="sb-organisms-upsell grid w-full gap-8 lg:grid-cols-[1fr_1fr]">
			...
			>
				...
				<p class="mt-1 text-[--color-text-primary]">
					RecipeUpsell component with upgrade recommendations.
				</p>
			...
			>
				...
				<div class="mt-5 space-y-4">
					...
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">Limited Products</p>
						<div>
							<RecipeUpsell
								{currentProduct}
