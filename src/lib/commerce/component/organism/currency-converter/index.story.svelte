		...
		<section class="sb-organisms-currency-converter grid w-full gap-8 lg:grid-cols-[1fr_1fr]">
			...
			>
				...
				<p class="mt-1 text-[--color-text-primary]">
					Interactive currency converter with real-time exchange rates.
				</p>
			...
			>
				...
				<div class="mt-5 space-y-4">
					...
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">EUR to GBP</p>
						<div>
							<RecipeCurrencyConverter
								amount={50}
								fromCurrency="EUR"
					...
					<article
						class="rounded-2xl border border-dashed border-[--color-border-primary] bg-[--color-background-primary] p-4"
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">JPY to USD</p>
						<div>
							<RecipeCurrencyConverter
								amount={10000}
								fromCurrency="JPY"
