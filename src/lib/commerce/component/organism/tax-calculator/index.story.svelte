		...
		<section class="sb-organisms-tax-calculator grid w-full gap-8 lg:grid-cols-[1fr_1fr]">
			...
			>
				...
				<p class="mt-1 text-[--color-text-primary]">
					Tax calculator with location and rate selection.
				</p>
			...
			>
				...
				<div class="mt-5 space-y-4">
					...
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">California Rates</p>
						<div>
							<RecipeTaxCalculator
								{locations}
								{taxRates}
					...
					<article
						class="rounded-2xl border border-dashed border-[--color-border-primary] bg-[--color-background-primary] p-4"
					>
						<p class="mb-2 text-sm font-semibold text-[--color-text-primary]">Simple Mode</p>
						<div>
							<RecipeTaxCalculator
								locations={[]}
								taxRates={[
