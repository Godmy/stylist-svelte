...
export interface SlotPriceAlertElement extends Omit<Props, 'variant' | 'size' | 'onclick' | 'class'>, Omit<InformationHTMLAttributes<HTMLDivElement>, 'variant' | 'size' | 'onclick'> {
  class?: string;
