<script lang="ts">
	...
	import { Card } from '$stylist/layout/svelte/molecule/layout/card';
	import { HorizontalLayout } from '$stylist/layout/svelte/atom/horizontal-layout';
	import { Spacer } from '$stylist/layout/svelte/atom/spacer';
	import { SplitLayout } from '$stylist/layout/svelte/molecule/layout/split-layout';
	import { StackedLayout } from '$stylist/layout/svelte/molecule/layout/stacked-layout';
	import { StickyLayout } from '$stylist/layout/svelte/molecule/layout/sticky-layout';
