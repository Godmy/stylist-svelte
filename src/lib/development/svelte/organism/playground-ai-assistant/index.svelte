<script lang="ts">
  import type { Props } from '$stylist/development/type/struct/playground-ai-assistant';
  import { createPlaygroundAiAssistantState } from '$stylist/development/function/state/playground-ai-assistant';
