<script lang="ts">
	...
	import { STYLIST_MENU_MENU_ITEMS } from '$stylist/development/const/record/stylist-menu-menu-items';
	import { STYLIST_MENU_FUNCTIONAL_TAB_ITEMS } from '$stylist/development/const/record/stylist-menu-functional-tab-items';
	import { STYLIST_MENU_ATOMIC_TAB_ITEMS } from '$stylist/development/const/record/stylist-menu-atomic-tab-items';
	import type { RecipeStylistMenu } from '$stylist/development/interface/recipe/stylist-menu';
