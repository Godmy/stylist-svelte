...
import type { PrimaryMenuItem } from '$stylist/development/interface/slot/primary-menu-item';
...
import { STYLIST_MENU_FUNCTIONAL_PRIMARY_SECTIONS } from '$stylist/development/const/record/stylist-menu-functional-primary-sections';

const functionalPrimarySections = new Set<string>(STYLIST_MENU_FUNCTIONAL_PRIMARY_SECTIONS);

export function createStylistMenuState(props: RecipeStylistMenu) {
