...
export const getChatPreviewContainerClasses = (className = '') =>
	['chat-preview border rounded-lg bg-white shadow-sm overflow-hidden', className]
		.filter(Boolean)
		.join(' ');
export const getChatPreviewHeaderClasses = () =>
	'p-4 border-b bg-gray-50 flex items-center justify-between';
...
export const getChatPreviewMessagesContainerClasses = () =>
...
export const getMessageInputContainerClasses = (className = '') =>
	['message-input flex items-end gap-2 p-3 rounded-xl border border-slate-200 bg-white', className]
		.filter(Boolean)
		.join(' ');
...
export const getMessageThreadHostClasses = (className = '') =>
	`message-thread flex flex-col h-full ${className}`.trim();
export const getMessageThreadHeaderClasses = (className = '') =>
	`bg-white border-b p-4 ${className}`.trim();
export const getMessageThreadContainerClasses = (className = '') =>
	`flex-1 overflow-y-auto ${className}`.trim();
