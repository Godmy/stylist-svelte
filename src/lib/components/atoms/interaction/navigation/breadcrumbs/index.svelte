<script lang="ts">
  ...
  import type { IBreadcrumbsProps } from '$stylist/design-system/interaction/navigation/breadcrumbs';
  import { BreadcrumbsStyleManager } from '$stylist/design-system/interaction/navigation/breadcrumbs';
