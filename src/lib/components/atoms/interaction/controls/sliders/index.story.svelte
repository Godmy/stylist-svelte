...
>
	{#snippet children(values: any)}
		...
		<section class="space-y-10">
			...
			<div
				class="rounded-3xl border border-[--color-border-primary] bg-[--color-background-primary] p-6 shadow-sm"
			>
				<div class="flex items-center justify-between">
					...
					<span class="text-xs font-semibold tracking-wide text-[--color-text-secondary] uppercase">
						Sample layout
					</span>
				</div>
				...
				<div class="relative mt-8 h-28">
					<div
						class="absolute top-1/2 left-0 h-[3px] w-full -translate-y-1/2 rounded-full bg-[--color-border-primary]"
					>
