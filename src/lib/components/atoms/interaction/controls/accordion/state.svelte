<script lang="ts">
  ...
  import type { AccordionHeaderProps, AccordionHeaderDoubleProps, AccordionItemProps, AccordionPanelProps, ComplexAccordionProps } from '$stylist/design-system/attributes';
