<script lang="ts">
  import { SkeletonCircleStyleManager } from '$stylist/design-system/interaction/feedback/placeholders/skeleton-circle';
  import type { ISkeletonCircleProps } from '$stylist/design-system/interaction/feedback/placeholders/skeleton-circle';
