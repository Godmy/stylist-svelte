...
<div class="space-y-8 p-6">
	<section class="rounded-2xl border border-[--color-border-primary] bg-white p-6 shadow-sm">
		<div class="grid gap-6 lg:grid-cols-[280px_1fr]">
			<div class="space-y-4">
				<div>
					<label class="text-sm font-medium text-[--color-text-secondary]" for="placeholder">
						Placeholder
					</label>
					<input
						id="placeholder"
				...
				<div
					class="rounded-xl border border-[--color-border-primary] bg-[--color-background-secondary] p-4 text-sm text-[--color-text-secondary]"
				>
