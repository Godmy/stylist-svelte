  ...
  {#snippet children(props: { })}
    <div class="p-4">
      <div class="mb-6 p-4 border rounded">
        <h2 class="text-md font-semibold mb-2">Interactive AccordionItem</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div class="p-4 border rounded">
          <h2 class="text-md font-semibold mb-2">AccordionItem with Different Values</h2>
          <ComplexAccordion>
            {#snippet content()}
              <AccordionItem value="different-1">
                <AccordionHeader value="different-1">
                  Different Value 1
                </AccordionHeader>
              ...
              <AccordionItem value="different-2">
                <AccordionHeader value="different-2">
                  Different Value 2
                </AccordionHeader>
        ...
        <div class="p-4 border rounded">
          <h2 class="text-md font-semibold mb-2">AccordionItem with Custom Styling</h2>
          <ComplexAccordion>
            {#snippet content()}
              <AccordionItem value="custom-1" class="border-blue-300 rounded-lg">
                <AccordionHeader value="custom-1">
                  Custom Styled Item
                </AccordionHeader>
      ...
      <div class="p-4 border rounded">
        <h2 class="text-md font-semibold mb-2">Default AccordionItem</h2>
        <ComplexAccordion>
          {#snippet content()}
            <AccordionItem value="default-item">
              <AccordionHeader value="default-item">
