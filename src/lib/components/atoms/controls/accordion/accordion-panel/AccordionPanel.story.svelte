  ...
  {#snippet children(props: { })}
    <div class="p-4">
      <div class="mb-6 p-4 border rounded">
        <h2 class="text-md font-semibold mb-2">Interactive AccordionPanel</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div class="p-4 border rounded">
          <h2 class="text-md font-semibold mb-2">AccordionPanel with Custom Content</h2>
          <ComplexAccordion>
            {#snippet content()}
              <AccordionItem value="custom-content">
                <AccordionHeader value="custom-content">
        ...
        <div class="p-4 border rounded">
          <h2 class="text-md font-semibold mb-2">AccordionPanel with Custom Styling</h2>
          <ComplexAccordion>
            {#snippet content()}
              <AccordionItem value="styled-panel">
                <AccordionHeader value="styled-panel">
                  Styled Panel
                </AccordionHeader>
                <AccordionPanel value="styled-panel" class="bg-yellow-50">{panelContent1}</AccordionPanel>
              </AccordionItem>
            {/snippet}
          </ComplexAccordion>
        </div>
      ...
      <div class="p-4 border rounded">
        <h2 class="text-md font-semibold mb-2">Default AccordionPanel</h2>
        <ComplexAccordion>
          {#snippet content()}
            <AccordionItem value="default-panel">
              <AccordionHeader value="default-panel">
