<script lang="ts">
	...
	const controls: ControlConfig[] = [
		...
		},
		{
			...
			options: ['primary', 'secondary', 'success', 'warning', 'danger', 'info', 'default', 'neutral', 'dark', 'light']
		},
		{
			name: 'shape',
			type: 'select',
...
<Story
	...
	title="IconWrapper Component"
	description="A wrapper component for icons with various styling options"
	tags={['information', 'media', 'icon', 'wrapper']}
>
