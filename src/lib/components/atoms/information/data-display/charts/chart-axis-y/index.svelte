<script lang="ts">
	import type { ChartAxisYProps } from '$stylist/design-system';
	import { createChartAxisYState } from '$stylist/design-system/models/information/chart-function.svelte';
