<script lang="ts">
	import type { ChartAxisZProps } from '$stylist/design-system';
	import { createChartAxisZState } from '$stylist/design-system/models/information/chart-function.svelte';
