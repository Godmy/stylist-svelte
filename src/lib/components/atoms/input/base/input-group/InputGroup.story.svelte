...
<div class="space-y-8 p-6">
  <section class="rounded-2xl border border-[--color-border-primary] bg-white p-6 shadow-sm">
    <div class="grid gap-6 lg:grid-cols-[320px_1fr]">
      <div class="space-y-4">
        <div>
          <label for="group-label" class="text-sm font-medium text-[--color-text-secondary]">Label</label>
          <input
            id="group-label"
  ...
  <section class="rounded-2xl border border-[--color-border-primary] bg-[--color-background-secondary] p-6">
    <h2 class="text-base font-semibold text-[--color-text-primary]">Повторно используемые паттерны</h2>
    <p class="text-sm text-[--color-text-secondary]">
