<script lang="ts">
  import KanbanCard from '../../../molecules/management/kanban/kanban-card/KanbanCard.svelte';
  import { Badge, Button, Input, Textarea } from '$lib/components/atoms';
    ...
    {#if showAddForm}
      <div class="add-form bg-white p-4 rounded-lg shadow-md mb-4 border border-gray-200">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label for="new-item-priority" class="block text-sm font-medium text-gray-700 mb-1">Приоритет</label>
            <select
