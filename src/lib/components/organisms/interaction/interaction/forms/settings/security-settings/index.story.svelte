<script lang="ts">
  ...
  import type { SecuritySettingsProps, SecuritySettings as SecuritySettingsType } from '$stylist/design-system/props';
  ...
  function handleSubmit(settings: SecuritySettingsType) {
      ...
      <div class="mb-6 p-4 border rounded">
        ...
        <div class="max-w-md">
          <SecuritySettingsComponent 
            ...
            showSessionManagement={props.showSessionManagement}
            showLoginHistory={props.showLoginHistory}
            showSecurityLevel={props.showSecurityLevel}
