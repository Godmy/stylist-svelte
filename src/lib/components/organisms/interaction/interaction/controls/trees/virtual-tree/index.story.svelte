...
<Story id="organisms-virtual-tree" title="Organisms / Interaction / Controls / Trees / Virtual Tree" component={TreeView} category="Organisms/Interaction/Controls/Trees">
  {#snippet children()}
