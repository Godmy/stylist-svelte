...
<Story
  ...
  controls={controls}
>
  {#snippet children(props: { searchable?: boolean; showPath?: boolean; enableFiltering?: boolean; defaultExpanded?: boolean })}
    <section class="grid w-full gap-8 lg:grid-cols-[1.25fr_0.75fr]">
