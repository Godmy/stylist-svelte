import type { IChatHeaderStyleClasses } from './types';
...
export class ChatHeaderStyleManager {
  static getHeaderClasses(): string {
    return 'chat-header flex items-center justify-between p-4 border-b border-[--color-border-primary] bg-[--color-background-primary]';
  }
