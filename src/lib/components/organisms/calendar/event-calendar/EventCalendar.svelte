<script lang="ts">
  import type { IEventCalendarProps, CalendarEvent, CalendarDay, CalendarViewMode } from './types';
  import { EventCalendarStyleManager } from './styles';
...
-->
<div class={wrapperClasses + ' ' + hostClass}>
  <!-- Calendar header -->
