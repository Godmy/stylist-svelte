<script context="module">
  ...
  export const category = "Molecules/Calendar";
</script>

<script lang="ts">
  import * as TimeGridModule from "./TimeGrid.svelte";
  const TimeGrid: any = TimeGridModule.default ?? TimeGridModule;
  import type { ITimeGridProps } from "./types";
