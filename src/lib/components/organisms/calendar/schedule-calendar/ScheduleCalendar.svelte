<script lang="ts">
  import type { IScheduleCalendarProps, ScheduleEvent, ScheduleTimeSlot, DaySchedule, EventPriority } from './types';
  import { TimeSlot } from '$lib/components/molecules/controls/calendar/time-slot';
  import { molecularTimeSlotToAtomic } from '$lib/components/molecules/controls/calendar/time-slot';
  import { ScheduleCalendarStyleManager } from './styles';
