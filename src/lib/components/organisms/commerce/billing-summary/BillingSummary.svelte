<script lang="ts">
  ...
  import { BillingSummaryStyleManager } from './styles';
  import type { IBillingSummaryProps } from './types';
...
<div class={BillingSummaryStyleManager.getContainerClasses(className)} {...restProps}>
