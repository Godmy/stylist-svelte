<script lang="ts">
  import { OrderConfirmationStyleManager } from './styles';
  import type { IOrderConfirmationProps, IOrderConfirmationEvents, OrderItem, ShippingAddress, OrderConfirmationPaymentInfo } from './types';
...
<div class={OrderConfirmationStyleManager.getBaseClasses(hostClass)} {...restProps}>
