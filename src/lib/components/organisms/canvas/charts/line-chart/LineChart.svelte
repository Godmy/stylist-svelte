 ...
 *
 * S - Single Responsibility Principle: This component is responsible only for displaying line charts
 * O - Open/Closed Principle: Extensible through properties without modifying the component's core logic
 * L - Liskov Substitution Principle: Can be replaced with another chart component without affecting the API
 * I - Interface Segregation Principle: Provides a minimal and focused interface for line charts
...
<script lang="ts">
  ...
  import { LineChartStyleManager } from './styles';
