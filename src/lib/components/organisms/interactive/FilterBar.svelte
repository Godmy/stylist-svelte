<script lang="ts">
  import Switch from '$lib/components/atoms/controls/Switch.svelte';
  import Tag from '$lib/components/atoms/typography/Tag.svelte';
  import RangeSlider from '$lib/components/atoms/controls/RangeSlider.svelte';
