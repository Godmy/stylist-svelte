<script lang="ts">
  ...
  import { CategoryCardStyleManager } from './styles';
...
<a href={link} class={classes} role="link" aria-label={`${title} category with ${count} components`}>
  <div class={linkWrapperClasses}>
    <div class={headerClasses}>
      <div class={iconContainerClasses}>
        <IconCircle icon={icon} size="md" variant="primary" />
      </div>
