<script lang="ts">
  ...
  import Divider from '../../atoms/ui-elements/Divider.svelte';
...
<div 
  class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 cursor-pointer transition-all hover:shadow-md"
