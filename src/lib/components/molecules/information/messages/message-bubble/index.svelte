<script lang="ts">
  ...
  import type { IMessageBubbleProps } from '$stylist/design-system/contracts/information/message-bubble';
  import { MessageBubbleStyleManager } from '$stylist/design-system/styles/information/message-bubble';
