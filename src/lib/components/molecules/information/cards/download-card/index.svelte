<script lang="ts">
  ...
  import type { IDownloadCardProps, DownloadCardVariant } from '$stylist/design-system/props/download-card';
  import { DownloadCardStyleManager } from '$stylist/design-system/styles/download-card';
