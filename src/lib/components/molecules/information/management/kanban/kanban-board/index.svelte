<script lang="ts">
  ...
  import KanbanColumn, { type KanbanColumnType } from '$stylist/components/molecules/information/management/kanban/kanban-column/index.svelte';
  import type { KanbanCardType } from '$stylist/components/organisms/information/card/kanban-card/index.svelte';
