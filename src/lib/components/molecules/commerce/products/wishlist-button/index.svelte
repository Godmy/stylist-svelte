<script lang="ts">
  ...
  import type { WishlistButtonProps } from '$stylist/design-system/props/molecules-migration';
  import { WishlistButtonStyleManager } from '$stylist/design-system/styles/molecules-migration';
