<script lang="ts">
  import type { ProductSearchProps } from '$stylist/design-system/props/molecules-migration';
  import { ProductSearchStyleManager } from '$stylist/design-system/styles/molecules-migration';
