<script lang="ts">
  ...
  import MessageMeta from '../../../molecules/message-meta/MessageMeta.svelte';
  import AttachmentPreview from '../../../molecules/files/attachment-preview/AttachmentPreview.svelte';
