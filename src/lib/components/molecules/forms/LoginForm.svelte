...
<form class={`max-w-md mx-auto p-6 bg-white rounded-lg shadow-md ${className}`} onsubmit={handleSubmit} {...restProps}>
  {#if showTitle}
  ...
  <div class="mb-4">
    <div class="flex justify-between items-center mb-1">
      ...
      {#if showForgotPassword}
        <a href={forgotPasswordHref} class="text-sm font-medium text-blue-600 hover:text-blue-500">Forgot password?</a>
      {/if}
    </div>
    <div class="relative">
      <input
    ...
    <div class="mt-6 text-center">
      <div class="flex justify-center space-x-4">
        {#each additionalLinks as link, i}
          <a href={link.href} class="text-sm text-blue-600 hover:text-blue-500">{link.text}</a>
