<script lang="ts">
  ...
  import CodeEditor from '$lib/components/molecules/development/code-editor/CodeEditor.svelte';
  import Badge from '$lib/components/atoms/typography/elements/badge/Badge.svelte';
