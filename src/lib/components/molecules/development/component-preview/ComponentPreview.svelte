<script lang="ts">
  ...
  import type { IComponentPreviewProps } from './types';
  import { ComponentPreviewStyleManager } from './styles';
  import CodeBlock from '../../../atoms/typography/elements/code-block/CodeBlock.svelte';
