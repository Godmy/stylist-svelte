<script lang="ts">
  import type { PropsEditorProps } from '$stylist/design-system/props/molecules-migration';
  import { PropsEditorStyleManager } from '$stylist/design-system/styles/molecules-migration';
