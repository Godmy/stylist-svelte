<script lang="ts">
  ...
  import type { ITeamMemberCardProps, IAchievement } from './types';
  import { TeamMemberCardStyleManager } from './styles';
  import Avatar from '../../../atoms/media/avatar/Avatar.svelte';
  import Badge from '../../../atoms/typography/badge/Badge.svelte';
