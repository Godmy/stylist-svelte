<script lang="ts">
  ...
  const dispatch = createEventDispatcher<ToolbarEvents>();
  ...
  export const clearCanvas = () => dispatch('clear-canvas', undefined);
  export const undo = () => dispatch('undo', undefined);
  export const redo = () => dispatch('redo', undefined);
  export const save = () => dispatch('save', undefined);
</script>
