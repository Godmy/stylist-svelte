<script lang="ts">
	import type { ConnectionLineProps } from '$stylist/design-system/contracts';
	import { createConnectionLineState } from '$stylist/design-system/models/information/connection-line.svelte';
