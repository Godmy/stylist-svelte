<script lang="ts">
  ...
  import * as CanvasDrawingSurfaceModule from './index.svelte';
      ...
      <div class="rounded-[2rem] border border-[--color-border-primary] bg-[--color-background-primary] p-6 shadow-sm">
        ...
        <div class="mt-6 flex flex-col items-center">
          ...
          <CanvasDrawingSurface
            ...
            tool={values.tool ?? tool}
            strokeColor={values.strokeColor ?? strokeColor}
            strokeWidth={values.strokeWidth ?? strokeWidth}
            width={500}
            height={300}
