<script lang="ts">
	import type { ChartCanvasProps } from '$stylist/design-system';
	import { createChartCanvasState } from '$stylist/design-system/models/information/chart-function.svelte';
	import ChartAxisX from '$stylist/components/atoms/information/data-display/charts/chart-axis-x/index.svelte';
	import ChartAxisY from '$stylist/components/atoms/information/data-display/charts/chart-axis-y/index.svelte';
	import ChartAxisZ from '$stylist/components/atoms/information/data-display/charts/chart-axis-z/index.svelte';
	import ChartBackground from '$stylist/components/atoms/information/data-display/charts/chart-background/index.svelte';
	import ChartName from '$stylist/components/atoms/information/data-display/charts/chart-name/index.svelte';
	import ChartPolyline from '$stylist/components/atoms/information/data-display/charts/chart-polyline/index.svelte';
