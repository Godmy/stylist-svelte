import { StatCardStyleManager } from '$stylist/analytics/class/style-manager/stat-card';
import { ObjectManagerStatCard } from '$stylist/analytics/class/object-manager/stat-card';
