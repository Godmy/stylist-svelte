<script lang="ts">
  ...
  import { LineChartStyleManager } from '$stylist/analytics/class/style-manager/line-chart';
  import { Icon } from '$stylist';
  import Tooltip from '$stylist/control/svelte/atom/controls/tooltip/index.svelte';
  import type { LineChartRecipe } from '$stylist/analytics/interface/recipe/line-chart';
  import { ObjectManagerLineChart } from '$stylist/analytics/class/object-manager/line-chart';
