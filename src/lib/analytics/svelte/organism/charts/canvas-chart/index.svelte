<script lang="ts">
  ...
  import { ObjectManagerCanvasChart } from '$stylist/analytics/class/object-manager/canvas-chart';
  import { CanvasChartStyleManager } from '$stylist/analytics/class/style-manager/canvas-chart';
