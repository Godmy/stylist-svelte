<script lang="ts">
  ...
  import { BarChartStyleManager } from '$stylist/analytics/class/style-manager/bar-chart';
  import type { BarChartRecipe } from '$stylist/analytics/interface/recipe/bar-chart';
  import { ObjectManagerBarChart } from '$stylist/analytics/class/object-manager/bar-chart';
