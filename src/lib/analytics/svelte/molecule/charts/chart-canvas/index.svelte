<script lang="ts">
	import type { ChartCanvasRecipe } from '$stylist/analytics/interface/recipe/chart-canvas';
	import type { ChartCanvasRecipe as InformationChartCanvasRecipe } from '$stylist/analytics/interface/recipe/chart-canvas';
	import { cn } from '$stylist/layout/function/script/merge-class-names';
	import { createChartCanvasState } from '$stylist/analytics/function/state/chart-function';
	import ChartAxisX from '$stylist/analytics/svelte/atom/charts/chart-axis-x/index.svelte';
	import ChartAxisY from '$stylist/analytics/svelte/atom/charts/chart-axis-y/index.svelte';
	import ChartAxisZ from '$stylist/analytics/svelte/atom/charts/chart-axis-z/index.svelte';
	import ChartBackground from '$stylist/analytics/svelte/atom/charts/chart-background/index.svelte';
	import ChartName from '$stylist/analytics/svelte/atom/charts/chart-name/index.svelte';
	import ChartPolyline from '$stylist/analytics/svelte/atom/charts/chart-polyline/index.svelte';
	import { ObjectManagerChartCanvas } from '$stylist/analytics/class/object-manager/chart-canvas';
