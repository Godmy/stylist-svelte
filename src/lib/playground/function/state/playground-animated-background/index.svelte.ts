import type { PlaygroundAnimatedBackgroundProps } from '$stylist/playground/type/struct/playground-animated-background-props';
import { PlaygroundAnimatedBackgroundStyleManager } from '$stylist/playground/class/style-manager/playground-animated-background';
...
export function createPlaygroundAnimatedBackgroundState(props: PlaygroundAnimatedBackgroundProps) {
	...
	const particlesContainerClass = $derived(
		PlaygroundAnimatedBackgroundStyleManager.getParticlesContainerClasses()
	);
	...
	const contentWrapperClass = $derived(
		PlaygroundAnimatedBackgroundStyleManager.getContentWrapperClasses()
	);
	...
	return {
		...
		get particlesContainerClass() {
			return particlesContainerClass;
		},
		get particleClass() {
			return particleClass;
		},
		get geoOverlayClass() {
			return geoOverlayClass;
		},
