...
export function createPlaygroundCtaButtonsState(props: PlaygroundCtaButtonsProps) {
	...
	const playgroundDescription = $derived(
		props.playgroundDescription ?? 'Test components with live controls and code generation'
	);
	...
	return {
		...
		get componentsHref() {
			return componentsHref;
		},
		get playgroundHref() {
			return playgroundHref;
		},
		get componentsTitle() {
			return componentsTitle;
		},
		get componentsDescriptionPrefix() {
			return componentsDescriptionPrefix;
		},
		get playgroundTitle() {
			return playgroundTitle;
		},
