<script lang="ts">
	...
	import { createShellHeaderState } from '$stylist/playground/function/state/shell-header/index.svelte';
	...
	let props: RecipeShellHeader = $props();

	const state = createShellHeaderState(props);
</script>
...
<div class={`shell-header ${state.className}`}>
	<div class="psh-left">
