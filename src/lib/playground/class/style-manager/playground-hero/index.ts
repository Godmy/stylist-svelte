...
export class PlaygroundHeroStyleManager {
	...
	static getContainerClasses(additionalClass: string = ''): string {
		const baseClasses =
			'relative overflow-hidden bg-gradient-to-br from-[--color-primary-50] to-[--color-background-secondary] dark:from-[--color-primary-900/20] dark:to-[--color-background-primary] rounded-2xl p-8 md:p-12';
