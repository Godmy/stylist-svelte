...
export const TIME_SLOT_DEFAULT_CONFIG: ITimeSlotStyleConfig = {
	...
	available:
		'bg-[--color-background-primary] border-[--color-border-primary] hover:bg-[--color-background-secondary] hover:border-[--color-border-hover]',
	unavailable:
		'bg-[--color-background-secondary] border-[--color-border-secondary] text-[--color-text-tertiary] cursor-not-allowed',
	selected:
		'ring-2 ring-[--color-primary-500] bg-[--color-primary-50] border-[--color-primary-300]',
