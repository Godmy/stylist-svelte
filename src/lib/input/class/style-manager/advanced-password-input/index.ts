...
export class AdvancedPasswordInputStyleManager {
	...
	static getInputClass(disabled: boolean, inputClass: string = ''): string {
		const baseClass =
			'w-full px-3 py-2 pr-10 border border-[--color-border-primary] rounded-md shadow-sm focus:outline-none focus:ring-[--color-primary-500] focus:border-[--color-primary-500]';
