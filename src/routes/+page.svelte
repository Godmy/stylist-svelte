...
<main class="relative min-h-screen overflow-hidden px-6 py-16 sm:py-20 lg:px-12">
  <div class="pointer-events-none absolute inset-0">
    <div
      class="absolute -left-24 top-[-6rem] h-80 w-80 rounded-full bg-[#f2d8c3] opacity-70 blur-3xl"
    ></div>
    <div
      class="absolute right-[-8rem] top-24 h-96 w-96 rounded-full bg-[#b6e2d7] opacity-70 blur-3xl"
    ></div>
    <div
  ...
  <div class="relative mx-auto flex w-full max-w-6xl flex-col gap-12">
    <header class="grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
      <div class="flex flex-col gap-6">
        ...
        <h1 class="display-font text-4xl font-semibold leading-tight text-[#1f1e1c] sm:text-5xl">
          {title}: деликатная система компонентов для выразительных интерфейсов
        </h1>

        <p class="max-w-2xl text-base text-[#3e3b37] sm:text-lg">
          {description} Стройте интерфейсы из согласованных токенов, аккуратных
          деталей и гибких сеток — всё в одном наборе.
        </p>
      ...
      <div class="glass-panel rounded-3xl border border-white/50 p-6 sm:p-8">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-xs uppercase tracking-[0.2em] text-[#7a3e3e]">Быстрый старт</p>
        ...
        <p class="mt-4 text-xs text-[#3e3b37]">
          Готово. Компоненты доступны сразу после импорта.
        </p>
      </div>
    </header>
    ...
    <section class="grid gap-6 lg:grid-cols-3">
      <div class="rounded-3xl border border-black/10 bg-white/80 p-6 shadow-sm">
        <p class="text-xs uppercase tracking-[0.2em] text-[#7a3e3e]">Токены</p>
        <h3 class="display-font mt-3 text-2xl font-semibold">Единый ритм</h3>
        <p class="mt-3 text-sm text-[#3e3b37]">
          Размеры, радиусы и шрифты согласованы так, чтобы дизайн ощущался цельным
          и спокойным.
        </p>
      </div>
      <div class="rounded-3xl border border-black/10 bg-white/80 p-6 shadow-sm">
        <p class="text-xs uppercase tracking-[0.2em] text-[#7a3e3e]">Компоненты</p>
        <h3 class="display-font mt-3 text-2xl font-semibold">Сильные основы</h3>
        <p class="mt-3 text-sm text-[#3e3b37]">
          Кнопки, поля, карточки и модальные окна готовы для продакшена и легко
          расширяются под ваш стиль.
        </p>
      </div>
      <div class="rounded-3xl border border-black/10 bg-white/80 p-6 shadow-sm">
        <p class="text-xs uppercase tracking-[0.2em] text-[#7a3e3e]">Интеграции</p>
        <h3 class="display-font mt-3 text-2xl font-semibold">Чистый Svelte</h3>
        <p class="mt-3 text-sm text-[#3e3b37]">
          Минимум обвязки, максимум скорости. Поддержка SSR, SvelteKit и
          стандартных сторов.
        </p>
      </div>
    </section>
    ...
    <section class="grid gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
      <div class="rounded-3xl border border-black/10 bg-[#1f1e1c] p-8 text-white shadow-lg">
        ...
        <p class="mt-3 text-sm text-white/80">
          Пять готовых шаблонов помогают быстрее собрать лендинг, панель или продуктовую
          страницу. Выберите стиль и замените контент.
        </p>
      ...
      <div class="space-y-4">
        <div class="rounded-3xl border border-black/10 bg-white/80 p-6 shadow-sm">
          <p class="text-xs uppercase tracking-[0.2em] text-[#7a3e3e]">Наблюдаемость</p>
          <h3 class="display-font mt-3 text-2xl font-semibold">Стабильные релизы</h3>
          <p class="mt-3 text-sm text-[#3e3b37]">
            Каждый компонент сопровождается примерами, а изменения документируются в
            подробном changelog.
          </p>
        </div>
        <div class="rounded-3xl border border-black/10 bg-white/80 p-6 shadow-sm">
          <p class="text-xs uppercase tracking-[0.2em] text-[#7a3e3e]">Гайдлайны</p>
    ...
    <section class="grid gap-6 lg:grid-cols-2">
      <div class="rounded-3xl border border-black/10 bg-white/80 p-6 shadow-sm">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-xs uppercase tracking-[0.2em] text-[#7a3e3e]">Темы</p>
            <h3 class="display-font mt-3 text-2xl font-semibold">Светлая и тёмная</h3>
          </div>
          <div class="rounded-full border border-black/10 bg-white/80 px-3 py-1 text-xs font-semibold text-[#3e3b37]">
            Preview
          </div>
        </div>
        <p class="mt-3 text-sm text-[#3e3b37]">
          Ниже — две карточки, каждая использует реальные токены тем и показывает,
          как выглядит библиотека в разных режимах.
        </p>
      </div>
      ...
      <div class="grid gap-4 sm:grid-cols-2">
        ...
        >
          <p class="text-xs uppercase tracking-[0.2em] text-[var(--color-text-tertiary)]">
            Light
          </p>
          <div class="mt-4 space-y-3 rounded-2xl border border-[var(--color-border-secondary)] bg-[var(--color-bg-primary)] p-4 text-[var(--color-text-primary)]">
            <p class="text-sm font-semibold">Светлый фон</p>
            <p class="text-xs text-[var(--color-text-secondary)]">
              Основные токены: фон, текст и границы.
            </p>
            <div class="flex gap-2">
              <span class="rounded-full bg-[var(--color-primary-500)] px-3 py-1 text-xs font-semibold text-[var(--color-text-inverse)]">
                Primary
              </span>
              <span class="rounded-full bg-[var(--color-success-500)] px-3 py-1 text-xs font-semibold text-[var(--color-text-inverse)]">
                Success
              </span>
            </div>
          </div>
        ...
        >
          ...
          <div class="mt-4 space-y-3 rounded-2xl border border-[var(--color-border-secondary)] bg-[var(--color-bg-primary)] p-4 text-[var(--color-text-primary)]">
            ...
            <div class="flex gap-2">
              ...
              <span class="rounded-full bg-[var(--color-warning-500)] px-3 py-1 text-xs font-semibold text-[var(--color-text-inverse)]">
                Warning
              </span>
            </div>
          </div>
